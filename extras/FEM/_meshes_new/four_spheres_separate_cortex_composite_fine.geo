...
sphere_r[] = {0.057,
              ...
              0.0875,
              0.09};
sphere_element_length_factor[] = {0.004,
                                  0.001,
                                  0.001,
                                  0.001,
                                  0.0025,
...
Physical Volume ("subcortical_structures") = {sphere_volumes[0],
                                              sphere_volumes[1]};
Physical Volume ("cortex") = {sphere_volumes[2]};
Physical Volume ("csf") = {sphere_volumes[3]};
