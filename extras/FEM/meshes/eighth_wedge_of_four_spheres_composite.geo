...
external_surfaces[] = sphere_surfaces[];
external_top = sphere_upper_pole;
external_bottom = sphere_lower_pole;
external_roi_radii[] = roi_radii[];
external_roi_nodes[] = roi_nodes[];
external_equatorial_nodes[] = equatorial_nodes[];
...
_top_axis = newl; Line(_top_axis) = {center, external_top};
_bottom_axis = newl; Line(_bottom_axis) = {external_bottom, center};
...
For _i In {0: 1}
  ...
  Line Loop(_loop) = {_top_axis,
                      ...
                      -_equatorial_line};
  Plane Surface(_surface) = {_loop};
  _dihedral_surfaces[_i * 2] = _surface;
  ...
  Line Loop(_loop) = {_bottom_axis,
                      ...
                      external_lower_meridians[_idx]};
  Plane Surface(_surface) = {_loop};
  _dihedral_surfaces[_i * 2 + 1] = _surface;
EndFor

volume_surfaces[] = {external_surfaces[],
                     _dihedral_surfaces[]};
Call MakeVolume;
subcortex_volume = volume;


roi_lower_pole = external_top;
roi_lower_radii[] = external_roi_radii[];
roi_lower_nodes[] = external_roi_nodes[];
...
_bottom_axis = newl; Line(_bottom_axis) = {sphere_lower_pole, external_bottom};

For _i In {0: 1}
  _idx = _i * (n_meridians - 1);

  _equatorial_line = newl; Line(_equatorial_line) = {external_equatorial_nodes[_idx],
                                                     equatorial_nodes[_idx]};
  ...
  Line Loop(_loop) = {_equatorial_line,
                      lower_hemisphere_meridians[_idx],
                      _bottom_axis,
                      -external_lower_meridians[_idx]};
  Plane Surface(_surface) = {_loop};
  _dihedral_surfaces[_i * 2 + 1] = _surface;
...
volume_surfaces[] = {surrounding_sector_surfaces[],
                     roi_side_surfaces[],
                     external_surrounding_sector_surfaces[],
                     _dihedral_surfaces[]};
Call MakeVolume;
surrounding_cortex_volume = volume;


brain_surfaces[] = sphere_surfaces[];
