...
os.makedirs(os.path.expanduser("~/test_fsaverage_high_res_no_mask"), exist_ok=True)
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_brain_mask"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "fsaverage"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_gt"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_potential"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_kesi"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_kesi_eigensources"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_kcsd"))
...
base_path = os.path.expanduser(os.path.join("~/test_fsaverage_high_res_no_mask", "test_kcsd_eigensources"))
