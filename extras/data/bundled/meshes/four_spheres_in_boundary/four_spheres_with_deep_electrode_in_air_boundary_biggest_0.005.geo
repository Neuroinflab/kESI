...
Box(10) = {-1000, -1000, -1000, 2000, 2000, 2000};
...
Field[1].VOut = 30; // Mesh size outside the cube
...
Field[2].VOut = 30; // Mesh size outside the cube
...
Field[3].VOut = 30; // Mesh size outside the cube
