...
Function SliceSaline3d
  ...
  elem_dome = {l4+1,l3+1,l1+1,l2+1,l25+1,l26+1,l27+1,l28+1};

  elem_model_base = {l17+1,l18+1,l19+1,l20+1,l21+1,l22+1,l23+1,l24+1};

  elem_saline = newreg;
  salinesurface = {l1+1,l2+1,l3+1,l4+1,l5+1,l6+1,l7+1,l8+1,l9+1,l10+1,l11+1,l12+1};
  ...
  elem_slice = newreg;
  slicesurface = {l9+1,l10+1,l11+1,l12+1,l13+1,l14+1,l15+1,l16+1,l21+1,l22+1,l23+1,l24+1,l25+1,l26+1,l27+1,l28+1};
  ...
  elem_roi = newreg;
  roisurface = {l5+1,l6+1,l7+1,l8+1,l13+1,l14+1,l15+1,l16+1,l17+1,l18+1,l19+1,l20+1};
